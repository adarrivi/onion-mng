...
@Configuration
@ComponentScan(basePackages = { "com.adarrivi.external.jpa", "com.adarrivi.core" })
@EnableJpaRepositories("com.adarrivi.external.jpa")
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("com.adarrivi.external.jpa");
